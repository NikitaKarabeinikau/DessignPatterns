...
exports.getMailbyID = exports.getMail = void 0;
var ServersManager_1 = require("../ServersManager");
var manager = new ServersManager_1.ServersManager();
var getMail = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var server, response, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                server = manager.chooseServer();
                return [4 /*yield*/, server.pool.query('SELECT mail FROM users;')];
            case 1:
                response = _a.sent();
...
var getMailbyID = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, server, response, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = parseInt(req.params.id);
                server = manager.servers[id];
                return [4 /*yield*/, server.pool.query('SELECT mail FROM users;')];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.status(200).json(response.rows)];
